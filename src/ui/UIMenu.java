...
public class UIMenu {
    ...
    public static final String[] MONTHS = {"Enero", "Febrero", "Marzo", "Abril", "Mayo", "Junio", "Julio", "Agosto", "Septiembre", "Noviembre", "Diciembre"};
    ...
    private static void authUser(int userType){
        ...
        patients.add(new Patient("Mauricio Avila", "mauricio@mail.com"));
